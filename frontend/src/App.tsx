...
const App: FC = () => {
    ...
    const addressValidator = (rule: any, value: any, callback: Function) => {
        if(!value || value.match(regex) || value.match(urlRegex))
            callback();
        else
            callback('Invalid website url or ip address')
    };
                ...
                <Content>
                    <Container>
                        ...
                        <div style={{backgroundColor: '#f1f1f1', padding: 20, borderRadius: 5}}>
                            ...
                            >
                                <Form.Item
                                    label="Website Url or IP address"
                                    name="address"
                                    rules={[
                                        {required: true, message: 'Url or Address is required'},
                                        {validator: addressValidator}
                                    ]}
                                >
                                    <Input
                                        placeholder="Enter the url or ip address"
                                    />
                                </Form.Item>
                                <Form.Item
                                    label="Email"
